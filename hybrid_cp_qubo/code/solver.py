...
5. Write a JSON record under ``hybrid_cp_qubo/results/``.

CLI
---
    python hybrid_cp_qubo/code/solver.py --size 10 --index 1 --matrix matrix00
    python hybrid_cp_qubo/code/solver.py --size 20 --index 1 --matrix matrix00 \\
        --qubo-backend sa
"""
